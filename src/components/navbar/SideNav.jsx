  ...
  return (
    <>
      ...
      <aside
        ...
        } bg-white dark:bg-[#0b0f14] text-gray-800 dark:text-gray-200 border-r border-gray-200 dark:border-gray-800 flex flex-col transition-all duration-300`}
      >
        {/* Header */}
        <div
          className={`flex items-center ${isCollapsed ? "justify-center" : "justify-between"} px-4 h-14 border-b border-gray-200 dark:border-gray-800`}
        >
          {isCollapsed ? (
        ...
        {!isCollapsed && (
          <div
            className="px-4 py-3 border-b border-gray-200 dark:border-gray-800 relative"
        ...
        <nav className="flex-1 overflow-y-auto py-2">
          {nav.map((section) => (
            <div key={section.id} className="mb-6">
              <SectionTitle isCollapsed={isCollapsed} tKey={section.tKey} t={t}>
                {section.title}
              </SectionTitle>
