...
import { useGetTermsConditionsQuery } from "@/features/terms-conditions/termsConditionsApiSlice";
                                ...
                                <div className="relative pl-12">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400 mt-1">
                                            {latestTerms.updatedAt ? new Date(latestTerms.updatedAt).toLocaleTimeString() : ""}
                                        </p>
                                    </div>
                                </div>
