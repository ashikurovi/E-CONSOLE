...
const PermissionManager = ({ userId, isOpen, onClose }) => {
  const [selectedPermissions, setSelectedPermissions] = useState([]);
  const { data: permissionsData, isLoading: isLoadingPermissions } = useGetPermissionsQuery(userId, {
    skip: !userId || !isOpen,
  });
  ...
  const handleSubmit = async () => {
    try {
      await assignPermissions({ id: userId, permissions: selectedPermissions }).unwrap();
