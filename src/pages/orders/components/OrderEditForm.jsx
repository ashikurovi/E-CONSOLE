...
const OrderEditForm = ({ order }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-lg p-0 gap-0 overflow-hidden backdrop-blur-2xl bg-white/90 dark:bg-gray-900/90 border border-white/50 dark:border-white/10 shadow-2xl rounded-2xl">
        <DialogHeader className="p-6 pb-4 border-b border-gray-200/50 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-900/20">
