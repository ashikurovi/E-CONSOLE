  ...
  const yourIntegrations = [
    {
      ...
      url: "https://loom.com",
      description:
        "Connect NexoviaSoft with Loom to automatically capture, transcribe, and organize video messages.",
    ...
    },
    {
      ...
      description:
        "Connect NexoviaSoft with Dropbox to capture, transcribe, and organize video insights automatically",
    ...
    },
    {
      ...
      description:
        "Connect NexoviaSoft with Zapier to automate workflows between NexoviaSoft and thousands of apps, enabling seamless data",
    ...
    },
    {
      ...
      description:
        "Connect NexoviaSoft with Github to track repositories, pull requests, and commits, allowing NexoviaSoft to",
      icon: (
    ...
    },
    {
      ...
      description:
        "Connect NexoviaSoft with Jira to sync issues, tickets, and project updates, giving NexoviaSoft full context to analyze progress",
    ...
    },
    {
      ...
      description:
        "Connect NexoviaSoft with Confluence to centralize documentation, sync knowledge, and enhance",
  ...
  const recommendedApps = [
    {
      ...
      description:
        "Integrate NexoviaSoft with GitLab to seamlessly sync your repositories and manage issues more effectively.",
    ...
    },
    {
      ...
      description:
        "Integrate NexoviaSoft with Notion to effectively centralize all your notes and tasks in one convenient location.",
      icon: (
    ...
    },
    {
      ...
      url: "https://gmail.com",
      description:
        "Integrate NexoviaSoft with your Gmail account to seamlessly extract valuable insights and actionable items.",
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              View, connect, and manage your integrations with NexoviaSoft.
            </p>
          </div>
