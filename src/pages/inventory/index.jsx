    ...
    <div className="min-h-screen bg-[#f7f8f9] dark:bg-[#0b0f14] p-4 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
           <Button variant="outline" onClick={() => exportProductsToPDF(processedData, "Inventory")} className="bg-white dark:bg-[#1a1f26] border-gray-200 dark:border-gray-800">
         ...
         <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <DropdownMenu>
               ...
               <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => setSortConfig({ key: 'createdAt', direction: 'desc' })}>Latest</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setSortConfig({ key: 'stock', direction: 'asc' })}>Stock: Low to High</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setSortConfig({ key: 'stock', direction: 'desc' })}>Stock: High to Low</DropdownMenuItem>
               </DropdownMenuContent>
            </DropdownMenu>
            ...
            <Table>
               <TableHeader className="bg-gray-50/50 dark:bg-white/5">
                  <TableRow>
                     ...
                     <TableHead className="font-semibold text-gray-900 dark:text-white">Product/Service</TableHead>
               ...
               <TableBody>
                  {isLoading ? (
                     [...Array(5)].map((_, i) => (
                        <TableRow key={i}>
                           <TableCell colSpan={8} className="h-16 animate-pulse bg-gray-50/50 dark:bg-white/5" />
                        </TableRow>
                     ))
                  ) : paginatedData.length === 0 ? (
                     <TableRow>
                        <TableCell colSpan={8} className="h-32 text-center text-gray-500">No inventory found</TableCell>
                     </TableRow>
                  ) : (
                           ...
                           <TableCell className="text-right pr-4">
                              <div className="flex items-center justify-end gap-2">
                                 <Button 
                                    ...
                                    onClick={() => navigate(`/manage-users/activity-logs?entityId=${product.id}`)}
                                 >
                                 ...
                                 <Button 
                                    ...
                                    onClick={() => setStockModal({ isOpen: true, product, type: 'in' })}
                                 >
                                 ...
                                 <Button 
                                    ...
                                    onClick={() => setStockModal({ isOpen: true, product, type: 'out' })}
                                 >
