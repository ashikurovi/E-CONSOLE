          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <div>
              <SectionHeader
                ...
                description="Upload a representative image to showcase this category in your store."
              />
                      ...
                      uploadType === "file" ? (
                        <>
                          ...
                          <p className="text-sm text-slate-500 max-w-xs mx-auto leading-relaxed">
                            Support for JPG, PNG and WebP. Recommended size
                            800x800px.
                          </p>
                          <input
                            type="file"
            ...
            <div>
              <SectionHeader
                ...
                description="Define the core details of your category."
              />
              <PremiumCard>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-slate-500">
                        {isActive ? "Visible in store" : "Not visible"}
                      </span>
                    </div>
                  </div>
                  <Switch
                  ...
                  >
                    <div className="flex items-center justify-between w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-indigo-500 hover:bg-white dark:hover:bg-slate-800 transition-all group">
                      <div className="flex items-center gap-2 overflow-hidden">
                        ...
                        >
                          {selectedParent?.label || "No Parent (Top Level)"}
                        </span>
                      </div>
            ...
            >
              ...
              <ul className="text-sm text-indigo-100 space-y-3 list-disc list-inside relative z-10">
                <li className="leading-relaxed">
                  Use high-quality images (800x800px) for the best visual
                  impact.
                </li>
                <li className="leading-relaxed">
                  Create a clear hierarchy to help customers navigate easily.
                </li>
              </ul>
            </motion.div>
          </div>
