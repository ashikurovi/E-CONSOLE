        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {orderItem.productId && (
                <div>
                  <label className="text-sm font-medium text-black/70 dark:text-white/70">Product ID</label>
                  <p className="text-base text-black dark:text-white mt-1">{orderItem.productId}</p>
                </div>
              )}
            </div>
            
            {orderItem.product && typeof orderItem.product === "object" && orderItem.product.description && (
              <div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-lg text-black dark:text-white mt-1 font-semibold">{orderItem.quantity || 0}</p>
              </div>
              <div>
